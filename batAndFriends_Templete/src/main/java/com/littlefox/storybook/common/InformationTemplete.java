...
public class InformationTemplete
{
	 ...
	 */
	public static final String COLOR_THUMBNAIL_BACKGROUND 		= "#ffee77";
	public static final String COLOR_INTRODUCTION_BACKGROUND 	= "#ed4983";
	 ...
	 * 앱 이름
	 */
	public static final String APP_NAME = "BatAndFriends";
	/**
	 * 어플리케이션의 패키지명 : 반드시 변경
	 */
	public static final String PACKAGE_NAME 				= "com.littlefox.storybook.batandfriends";
	
	/**
	 * 영상이 저장될 위치 : 반드시 변경
	 */
	public static final String MP4_FILE_PATH 				= Environment.getExternalStorageDirectory() + File.separator + "Littlefox"+ File.separator+"Storybook"+File.separator+"BatAndFriends"+File.separator;
	
	/**
	 * 로그 파일 저장 명  : 반드시 변경
	 */
	public static final String LOG_FILE						= "story_book_bat_and_friends.txt";
	 ...
	 */
	public static final String APP_LINK = "https://play.google.com/store/apps/details?id=com.littlefox.storybook.batandfriends";
	 ...
	 */
	public static final String HTTP_HEADER_APP_NAME = "LF_App_Storybook_BatAndFriends";
	
	/**
	 * 구글 애널리틱스를 등록했던 앱의 ID
	 */
	public static final String GOOGLE_ANALYTICS_PROPERTY_ID = "UA-37277849-8";
	
	/**
	 * 하나 아이템의 SKU
	 */
	public static final String ONE_PAY_ITEM_SKU = "lf_sb_baf_1";
	
	/**
	 * 전체 아이템의 SKU
	 */
	public static final String ALL_PAY_ITEM_SKU = "lf_sb_baf_all";
	
	/**
	 * 결제 관련 IN APP BILLING KEY : 앱을 베타테스트로 Publish 한 후에 해당 어플리케이션 정보에서 Services & APIs 항목의  Licensing & IN-APP Billing 의 키를 복사하여 바꾼다.
	 */
	public static final String IN_APP_BILLING_KEY = "";
	 ...
	 * 서버 어플리케이션의 서버키 
	 */
	public static final String SERVER_KEY = "AIzaSyCLPYp6pIz12mNHm854qJ_IZF5rNYARblE";
	
	/**
	 * Google API Console 에 등록한 Project ID
	 */
	public static final String SENDER_ID = "756975820703";
